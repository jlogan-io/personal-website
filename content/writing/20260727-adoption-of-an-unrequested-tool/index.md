...
Keeping a risk register on this has been more instructive than I expected, and
not because of any individual entry. It is that the dominant risk has moved
twice.
...
More recently it has moved again, to evidentiary credibility. A time-savings
claim with no quality check behind it is vulnerable on exactly the grounds the
research literature identifies, and being vulnerable there would undo the
adoption work regardless of how good the tool is.
...
The single most useful thing anyone has told me about this came out of a
review with people outside the project: the lever is traceability, not
accuracy.
...
That reframed the grounding work entirely. Grading output against its sources
started in my head as quality assurance. It is really a change management
mechanism, because citable grounding is what lets someone verify rather than
believe.

## What the executive review asked about

The first external gate was an executive review a couple of weeks ago. The
questions were not about capability. They were about data privacy, output
reliability, and workflow integration, in that order.
...
Those are now the agenda, and two of the three were already answered by
architecture decisions made much earlier for different reasons. Keeping
program data local stopped being a technical preference and became the answer
to the first question anyone senior asked.

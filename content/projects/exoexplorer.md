...
summary: >-
  ...
  Archive in 3D — host star at the centre, planets on their real orbits,
  physical data a tap away. Expo + React Native, three.js on expo-gl.
highlights:
...
# This one already has a full write-up in the home lab. Point the card there
# rather than publishing a second page saying the same thing.
link: /writing/20260825-exoexplorer/
# ...so this one publishes no page of its own. It still feeds the card.
build:
  render: never
  list: local
---
